...
function Contact(){
    return(
        <div>
            <h1>Contact us:</h1>
            <p>We are thrilled to hear from you! Whether you have questions, want to learn more about our tutoring services, or are ready to get started, our team is here to assist you. Feel free to reach out to us through any of the following channels:</p>
            <h4>Phone: +1-123-456-7890 <br></br>
                Email: info@cognitutoring.com
            </h4>
            <h3>Office Hours:</h3>
